 ...
 */
export const settleWithoutPaymentChecker = new PaymentMethodEligibilityChecker({
  code: 'settle-without-payment-checker',
  description: [
    {
      languageCode: LanguageCode.en,
      value: 'Checks if the logged-in customer is in given group',
    },
  ],
  args: {
    customerGroupId: {
