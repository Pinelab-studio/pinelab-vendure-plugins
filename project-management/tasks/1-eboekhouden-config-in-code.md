# E-boekhouden plugin: Move configuration to code

## Goal


Move the E-boekhouden configuration from the UI/admin to plugin initialization code via a strategy function.

## Required Changes

- [ ] Add `getEBoekhoudenConfig(ctx): Config | false` to plugin options.
